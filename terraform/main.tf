...
######################## RESOURCE GROUP 1 ########################
resource "azurerm_resource_group" "spring-app1" {
  name     = "spring-app1"
  location = "UK South"
}
### CLUSTER ###
resource "azurerm_kubernetes_cluster" "cluster" {
  name                = "spring-cluster"
  location            = azurerm_resource_group.spring-app1.location
  resource_group_name = azurerm_resource_group.spring-app1.name
